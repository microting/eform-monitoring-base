...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.EformMonitoringBase/Microting.EformMonitoringBase.csproj package Microting.eForm
	dotnet add Microting.EformMonitoringBase/Microting.EformMonitoringBase.csproj package Microting.eFormApi.BasePn
